...
Pixel a シリーズ（4a → 10a）の個人用リファレンスページ「**Pixel 整備手帳**」。スペック比較・開発者オプション・サポート期限・公式ヘルプリンク・電話/Gmail 機能・OS別不具合マトリクス・トラブルシューティング・専門TS（ADB / fastboot / コードネーム / 復旧手順）を 1 枚の静的 HTML に集約したもの。
